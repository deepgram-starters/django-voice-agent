...
Django demo app for Deepgram Voice Agent.
...
```
feat(django-voice-agent): add diarization support
fix(django-voice-agent): resolve WebSocket close handling
refactor(django-voice-agent): simplify session endpoint
